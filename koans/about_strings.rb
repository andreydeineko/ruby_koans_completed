...
EOS
  ...
  def test_the_shovel_operator_modifies_the_original_string
   ...
   # You have a glass of water that is half full and you need to refill your glass.
    #First way you do it by taking a new glass, filling it halfway with water from a tap and then using this second 
    # half-full glass to refill your drinking glass. You do this every time you need to refill your glass.
    ...
    #The same applies to the shovel operator and the plus equal operator. Plus equal operator gets a new 'glass' every time it 
    # needs to refill his glass while the shovel operator just takes the same glass and refills it. 
    # So at the end of the day more 'glass' collection for the Plus equal operator.
  end
