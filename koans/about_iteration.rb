...
class AboutIteration < EdgeCase::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # in first example adding of elements from array started with 0 (passed as a parameter in injected(0))
    # in second example multiplying was (1 *2* 3 * 4) because we have passed a parameter to inject(). If the parameter was not passed,
    # operation starts from the first element in object on which the method called (in our case array)
  end
